  ...
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s8 w3-bar">
      <?php  if (isset($_SESSION['user'])) : ?>
				...
				<?php endif ?>
      <a href="settings.php" class="w3-bar-item w3-button"><i class="fa fa-cog"></i>  setting's</a>
    </div>
  </div>
  <hr>
...
<?php
$getusername = $_SESSION['user']['username'];
$objConnect = mysql_connect("localhost","root","fox91628") or die("Error Connect to Database");
$objDB = mysql_select_db("thelogicdeskdb");
...
<td align="center"><a href="editrecord.php?ticketID=<?php echo $objResult["ticket_no"];?>">assign ticket</a></td>
</tr>
<?php
}
?>
