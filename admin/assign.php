...
<!DOCTYPE html>
<html>
<title>TheLogicDesk | Assign</title>
<meta charset="UTF-8">
...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span  class="w3-bar-item w3-left" href="../index.php">TheLogicDesk</span>
...
<header class="w3-container" style="padding-top:22px">
    <h5><b></i> Assign a ticket </b></h5>
  </header>
  <body>
<?php
$strSQL = "SELECT * FROM tickets Where status='open' ";
