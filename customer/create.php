...
<!DOCTYPE html>
<html>
<title>TheLogicDesk | Create a Ticket</title>
<meta charset="UTF-8">
...
<!-- Top container -->
<div class="w3-bar w3-to$title$titlep w3-black w3-large" style="z-index:4">
...
<header class="w3-container" style="padding-top:22px">
    <h5><b></i> Create a Ticket</b></h5>
  </header>
  
<form class="text-center" action="createf.php" method="post">

    Ticket Title <input type="text" div class="input-group" name="title"><br>
    description <input type="text" div class="input-group" name="description"><br>
    contact number <input type="text" div class="input-group" name="contact_num"><br>
